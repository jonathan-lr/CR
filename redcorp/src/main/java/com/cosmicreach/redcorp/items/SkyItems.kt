...
class SkyItems {
    ...
    fun skyWings() : ItemStack {
        val item = ItemStack(Material.ELYTRA, 1)

        NBT.modify(item) { nbt ->
            nbt.setInteger("item-id", 11)
        }
        ...
        val modifier1 = AttributeModifier(NamespacedKey(RedCorp.getPlugin(), "sky-wings-armor"), 8.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.CHEST)
        val modifier2 = AttributeModifier(NamespacedKey(RedCorp.getPlugin(), "sky-wings-armor-toughness"), 3.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.CHEST)
        val modifier3 = AttributeModifier(NamespacedKey(RedCorp.getPlugin(), "sky-wings-knockback-resistance"), 0.1, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.CHEST)
