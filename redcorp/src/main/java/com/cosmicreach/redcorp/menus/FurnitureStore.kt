...
class FurnitureStore () {
    ...
    fun makeGUI(player: Player): Gui {
        ...
        val gui = Gui.normal()
            ...
            .addIngredient('>', IncreaseItemAmount(listOf(agingBarrelItem, coffeeMachineItem, grinderItem, industrialGrinderItem, dryingRackItem, mixerItem, pressItem, slotItem, greenhouse, greenhouseUpgrade)))
            .addIngredient('<', DecreaseItemAmount(listOf(agingBarrelItem, coffeeMachineItem, grinderItem, industrialGrinderItem, dryingRackItem, mixerItem, pressItem, slotItem, greenhouse, greenhouseUpgrade)))
            .build()
        return gui
    }
}