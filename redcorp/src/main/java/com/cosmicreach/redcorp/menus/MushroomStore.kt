...
class MushroomStore(private var econ: Economy) {
    ...
    fun makeGUI(player: Player): Gui {
        ...
        val shroomItem = ShopItem(player, econ, balItem, DrugItems().Shrooms(1),"§5Toad", name = "shroom")
        val truffleItem = ShopItem(player, econ, balItem, DrugItems().Truffles(1),"§5Toad", name = "truffle")
